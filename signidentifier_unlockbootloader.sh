...
#
# Command usage:
#./signidentifier_unlockbootloader.sh IDENTIFIER PRIVATE_KEY SIGNATURE
#
# **************** #
# input parameters #
# **************** #
...
doInit()
{
	if [ $# -ne 3 ]; then
		...
		echo "Usage:"
		echo "./signidentifier_unlockbootloader.sh  identifier private_key signature"
		return 1
	fi
...
#test command
#./signidentifier_unlockbootloader.sh 30313233343536303839414243444546 rsa4096_vbmeta.pem signature.bin
